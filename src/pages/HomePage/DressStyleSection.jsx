    ...
    <section className="container mx-auto px-4 xl:px-0 ">
      <div className="bg-lightGrey rounded-[20px] pb-4 px-6 xl:px-16">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full mb-4">
          <figure
            className="relative rounded-[20px] overflow-hidden w-full h-[190px] lg:h-[289px] lg:w-2/5"
            onClick={handleClick}
          >
          ...
          <figure
            className="relative rounded-[20px] overflow-hidden w-full h-[190px] lg:h-[289px] lg:w-3/5 "
            onClick={handleClick}
          >
